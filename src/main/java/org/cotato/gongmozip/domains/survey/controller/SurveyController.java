...
public class SurveyController {
    ...
    @Operation(
            ...
            description =
                    ...
                    **요청 형식**
                    ...
                    - 15개 필수 문항을 모두 포함해야 합니다. 누락 시 `SURVEY_005` 에러.
                    - 선택지가 해당 질문에 속하지 않으면 `SURVEY_004` 에러.

                    **재제출은 직전 제출 후 3개월이 지난 시점부터 가능**합니다.
                    3개월 이내에 다시 제출하면 `SURVEY_006` 에러를 반환하며, 기존 답변과 결과는 유지됩니다.
    ...
    @Operation(
            ...
            description =
                    ...
                    - 설문을 제출한 적 없으면 `SURVEY_001` 에러를 반환합니다.

...
public enum AuthErrorCode implements BaseErrorCode {
    ...
    LOGIN_LOCKED(HttpStatus.UNAUTHORIZED, "AUTH_401_7", "비밀번호를 5회 이상 잘못 입력하여 로그인이 제한되었습니다. 비밀번호를 재설정해 주세요."),
    TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH_401_8", "액세스 토큰이 만료되었습니다. 토큰을 재발급해 주세요."),

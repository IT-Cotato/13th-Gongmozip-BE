 ...
 * 자세한 설계 배경은 docs/decisions/11-notification.md 참고.
 */
@Service
...
public class NotificationService {
    ...
    /** 팀원 여러 명에게 동시에 남기는 챗봇 카드 알림(CHATROOM 카테고리) — 팀원 수만큼 알림 행을 생성한다. */
    @Transactional
    ...
    /** 매칭 신청 완료/결과 공개 등 MATCHING 카테고리 알림. relatedTeamId는 아직 팀이 없으므로 null. */
    @Transactional
